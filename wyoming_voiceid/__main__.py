...
from voiceid.api.app import create_app
from voiceid.config import get_settings
from voiceid.core.context import build_context
from voiceid.core.info_cache import UpstreamInfoCache, parse_languages

from .handler import VoiceIDHandler

_LOGGER = logging.getLogger("voiceid.main")
...
async def main() -> None:
    ...
    _LOGGER.info("VoiceID v%s starting…", __version__)
    ...
    handler_factory = partial(VoiceIDHandler, info_cache, context)
