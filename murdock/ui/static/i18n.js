...
const I18N = (() => {
    const TRANSLATIONS = {
        en: {
            ...
            "stt.openai_hint": "OpenAI: https://api.openai.com + gpt-4o-transcribe · Groq: https://api.groq.com/openai + whisper-large-v3-turbo · local (speaches etc.): http://host:8000, key can stay empty.",
        ...
        de: {
            ...
            "stt.openai_api_key": "API-Key",
            "stt.openai_hint": "OpenAI: https://api.openai.com + gpt-4o-transcribe · Groq: https://api.groq.com/openai + whisper-large-v3-turbo · lokal (speaches etc.): http://host:8000, Key kann leer bleiben.",
