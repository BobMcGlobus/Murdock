...
const I18N = (() => {
    const TRANSLATIONS = {
        en: {
            ...
            "ha.description": "Connect Murdock to your Home Assistant instance to push speaker recognition results. Leave URL and token empty to disable the integration.",
        ...
        de: {
            ...
            // -- Home Assistant --
            "ha.title": "Home Assistant",
            "ha.description": "Verbinde Murdock mit deiner Home Assistant-Instanz, um Sprechererkennungs-Ergebnisse zu senden. URL und Token leer lassen, um die Integration zu deaktivieren.",
            "ha.url": "Home Assistant URL",
            "ha.ph_url": "http://192.168.1.100:8123",
